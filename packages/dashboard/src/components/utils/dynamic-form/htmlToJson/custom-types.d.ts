...
export type SubheadingLayout = ContentObjectBase<"Subheading", { subheading: string; level?: number }>;
export type ListItem = ContentObjectBase<"ListItem", string>;
export type ListLayout = ContentObjectBase<"List", { style: "unordered" | "ordered"; items: ListItem[] }>;
export type TableLayout = ContentObjectBase<"Table", { withHeadings: boolean; content: string[][] }>;
export type ImageLayout = ContentObjectBase<"Image", { src: string; alt?: string, mediaId: string }>;
export type QuoteLayout = ContentObjectBase<"Quote", { text: string; caption?: string }>;
export type CodeLayout = ContentObjectBase<"Code", { code: string; language?: string }>;
