...
const UpdateTag: FunctionComponent<UpdateTagProps> = ({id}) => {
    ...
    return (
        <ExtensionZone name="tag-update" page="tags" entity="tag" data={{tag, loading, error}}>
            <div className="max-w-4xl mx-auto p-2 md:p-6">
                ...
                {loading ? (
                    ...
                    <>
                        ...
                        <ExtensionZone name="tag-update-form" page="tags" entity="tag" data={{tag, fields: getFormFields()}}>
