...
const CreateCategory: FunctionComponent<CreateCategoryProps> = () => {
    ...
    return (
        <ExtensionZone name="category-create"
                       context={{zone: 'category-create', page: 'categories', entity: 'category'}}>
            <div className="max-w-4xl mx-auto p-2 md:p-6">
                ...
                <ExtensionZone name="category-create-form" context={{
                    zone: 'category-create-form',
                    page: 'categories',
                    entity: 'category',
                    data: {fields}
                }}>
